	...
	var table =  $('#parentTable').on( 'error.dt', function ( e, settings, techNote, message ) {
	    	...
	    	ajax:{
			 ...
			 columns: [
				 ...
				 {"data": 'address'},
				 {"data": 'createDate'},
				 {"data": null, "defaultContent":'<button class="btn btn-sm btn-success fa fa-file-powerpoint-o" title=""></button>'}
				]
	    });
	
		 
		$('#parentTable tbody').on( 'click', 'td', function () {
	        ...
	        bootbox.dialog({
				...
				'</div>',
	    		onEscape: function() {
	    			console.log("this got cancelled");
	    		},
	    		buttons: {
	    			success:{
	    				label: "Save!",
