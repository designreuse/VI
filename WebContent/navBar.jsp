<script src="./js/branchmanager/logout.js"></script>
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="adminMain.jsp" class="logo">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Admin One</span>
            </a>
...
<!--                   <a href="landingPage.jsp" onsubmit="logout()return false;" class="btn btn-default btn-flat">Sign out</a> -->
                </div>
              </li>
            </ul>
          </li>
