...
public class Message {
	...
	public static final String DIRNOTEXIST = "Directory does not exist.";
	public static final String FOLDERNOTEXIST = "Folder does not exist.";
	public static final String FILETOOLARGE1 = "File too large 1.";
	public static final String FILETOOLARGE2 = "File too large 2.";
	public static final String NOUPLOADREQUEST = "No upload request.";
	...
	public static final String BRANCHMANAGERNOTEXIST = "The branch manager does not exist.";
	...
	public static final String DIAGNOSTICNOTEXIST = "The diagnostic does not exist.";
	public static final String SCHEDULEEVENTNOTEXIST = "The schedule event does not exist.";
	public static final String CAMPAIGNNOTEXIST = "The campaign does not exist.";
