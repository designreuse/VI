 ...
 * @author RaySong
 */
public class GetSchedulesByTeacherAndCourseServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetSchedulesByTeacherAndCourseServlet() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = ScheduleCtrl.getSchedulesByTeacherAndCourse(inputJson);
		}catch(Exception e){
			e.printStackTrace();
