 ...
 * @author RaySong
 */
public class GetScheduleEventsByScheduleServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetScheduleEventsByScheduleServlet() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = ScheduleEventCtrl.getScheduleEventsBySchedule(inputJson);
		}catch(Exception e){
			e.printStackTrace();
