...
/**
 * Servlet implementation class GetSchedulesByCourseName
 */
public class GetSchedulesByCourseName extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetSchedulesByCourseName() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = ScheduleCtrl.getSchedulesByCourseName(inputJson);
		}catch(Exception e){
			e.printStackTrace();
