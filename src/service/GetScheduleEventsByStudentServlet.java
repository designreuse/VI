 ...
 * @author RaySong
 */
public class GetScheduleEventsByStudentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetScheduleEventsByStudentServlet() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = ScheduleEventCtrl.getScheduleEventsByStudent(inputJson);
		}catch(Exception e){
			e.printStackTrace();
