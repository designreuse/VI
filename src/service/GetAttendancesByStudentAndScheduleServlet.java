 ...
 * @author RaySong
 */
public class GetAttendancesByStudentAndScheduleServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetAttendancesByStudentAndScheduleServlet() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = AttendanceCtrl.getAttendancesByStudentAndSchedule(inputJson);
		}catch(Exception e){
			e.printStackTrace();
