 ...
 * 
 */
public class GetAttendancesByClassroom extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetAttendancesByClassroom() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = AttendanceCtrl.getAttendancesByClassroom(inputJson);
		}catch(Exception e){
			e.printStackTrace();
