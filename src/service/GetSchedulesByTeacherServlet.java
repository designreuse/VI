 ...
 * @author RaySong
 */
public class GetSchedulesByTeacherServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetSchedulesByTeacherServlet() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = ScheduleCtrl.getSchedulesByTeacher(inputJson);
		}catch(Exception e){
			e.printStackTrace();
