 ...
 * @author RaySong
 */
public class GetFeedbacksByTeacherAndStudentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetFeedbacksByTeacherAndStudentServlet() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = TeacherFeedbackCtrl.getTeacherFeedbacksByTeacherAndStudent(inputJson);
		}catch(Exception e){
			e.printStackTrace();
