 ...
 * @author RaySong
 */
public class CreateDiagnosticsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CreateDiagnosticsServlet() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = DiagnosticCtrl.createDiagnosticsForStudent(inputJson);
		}catch(Exception e){
			e.printStackTrace();
