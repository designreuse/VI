 ...
 * @author RaySong
 */
public class GetBranchCoursesByBranchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetBranchCoursesByBranchServlet() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = BranchCourseCtrl.getBranchCoursesByBranch(inputJson);
		}catch(Exception e){
			e.printStackTrace();
