 ...
 * @author RaySong
 */
public class GetScheduleEventsByCourseServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetScheduleEventsByCourseServlet() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = ScheduleEventCtrl.getScheduleEventsByCourse(inputJson);
		}catch(Exception e){
			e.printStackTrace();
