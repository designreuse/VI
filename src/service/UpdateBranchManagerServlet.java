 ...
 * @author RaySong
 */
public class UpdateBranchManagerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateBranchManagerServlet() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = BranchManagerCtrl.updateBranchManager(inputJson);
		}catch(Exception e){
			e.printStackTrace();
