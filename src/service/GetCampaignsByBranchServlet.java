...
import controller.CampaignCtrl;
 ...
 * @author RaySong
 */
public class GetCampaignsByBranchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetCampaignsByBranchServlet() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = CampaignCtrl.getCampaignsByBranch(inputJson);
		}catch(Exception e){
			e.printStackTrace();
