...
/**
 * Servlet implementation class UpdateAttendanceWithQRServlet
 */
public class UpdateAttendanceWithQRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateAttendanceWithQRServlet() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = AttendanceCtrl.updateAttendanceWithQR(inputJson);
		}catch(Exception e){
			e.printStackTrace();
