 ...
 * @author RaySong
 */
public class CreateAttendancesForStudentByScheduleServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CreateAttendancesForStudentByScheduleServlet() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = AttendanceCtrl.createAttendancesForStudentBySchedule(inputJson);
		}catch(Exception e){
			e.printStackTrace();
